...
void Animation::buildAnimation(sf::Vector2i cellSize, int initialY, int maxFrames, bool loop, float frameSpeed)
{
	for (int i = 0; i < maxFrames; i++) {
		addFrame(sf::IntRect(i * cellSize.x, initialY, cellSize.x, cellSize.y));
	}
